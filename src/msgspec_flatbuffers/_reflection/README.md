...
from `reflection` to `msgspec_flatbuffers._reflection` so the generated imports
remain private to this package. No field definitions were changed.
...
adapter in `msgspec_flatbuffers._schema_reader` remains type-checked.
